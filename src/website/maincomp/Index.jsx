    ...
    <div className="container py-5">
      <div className="row justify-content-center">
        <div className="col-lg-10 text-center">
          <h1 className="display-3 text-white animated slideInDown">Home</h1>
...
served many Small, Medium & multinational companies for their fresh recruitments.
We care for the future of the candidates and try give our contribution in it when they are trying to make it a 
bright future
</p>
